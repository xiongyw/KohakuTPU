...
module vec_tables (
    ...
    // heuristic is what CLAUDE.md's rule forbids.
    (* rom_style = "distributed" *) output reg signed [21:0] c0,
    (* rom_style = "distributed" *) output reg signed [21:0] c1,
    (* rom_style = "distributed" *) output reg signed [21:0] c2
);
