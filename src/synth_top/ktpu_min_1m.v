// ktpu_min_1m -- GENERATED by scripts/py/gen_mesh.py. Do not edit by hand.
//
//   xxx vec xxx
//   mag mat nul
//   xxx nul xxx
//
// 1x1 routers, 1 MAG port(s), 1 cluster(s), 1 vector core(s).
// GRID_X_HI=1 GRID_Y_HI=1: the clamp is per axis, so the grid need not
...
module ktpu_min_1m #(
    ...
    localparam integer NCU  = 1;
    localparam integer NVEC = 1;
    ...
    assign l001_h1_1_rd = {FW{1'b0}}; assign l001_h1_1_rv = 1'b0; assign l001_h1_1_fb = 1'b0;
    assign l003_v1_1_rd = {FW{1'b0}}; assign l003_v1_1_rv = 1'b0; assign l003_v1_1_fb = 1'b0;
