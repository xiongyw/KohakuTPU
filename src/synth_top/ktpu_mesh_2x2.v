// ktpu_mesh_2x2 -- GENERATED by scripts/py/gen_mesh.py. Do not edit by hand.
//
//   xxx vec vec xxx
//   mag mat nul nul
//   mag mat nul nul
//   xxx vec vec xxx
//
// 2x2 routers, 2 MAG port(s), 2 cluster(s), 4 vector core(s).
...
module ktpu_mesh_2x2 #(
    ...
    mx_cluster_cu #(.FLIT_WIDTH(FW), .POS_WIDTH(PW),
                    .CU_X(1), .CU_Y(2),
                    .MEM_X(0), .MEM_Y(2), .MODEL(MODEL)) u_cu1 (
        .clk(clk), .resetn(resetn),
    ...
    assign l015_L2_2_fd = {FW{1'b0}}; assign l015_L2_2_fv = 1'b0; assign l015_L2_2_rb = 1'b0;
