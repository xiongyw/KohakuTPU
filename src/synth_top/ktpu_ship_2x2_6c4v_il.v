// ktpu_ship_2x2_6c4v_il -- GENERATED by scripts/py/gen_mesh.py. Do not edit by hand.
//
//   xxx vec vec xxx
//   mag mat mat mat
//   mag mat mat mat
//   xxx vec vec xxx
//
// 2x2 routers, 2 MAG port(s), 6 cluster(s), 4 vector core(s).
...
module ktpu_ship_2x2_6c4v_il #(
    ...
    mx_cluster_cu #(.FLIT_WIDTH(FW), .POS_WIDTH(PW),
                    .CU_X(3), .CU_Y(1), .TILES(TILES), .GA(GA), .GB(GB),
                    .L1_PRIM(L1_PRIM),
                    .INST_DEPTH(INST_DEPTH), .RECV_DEPTH(RECV_DEPTH),
    ...
    mx_cluster_cu #(.FLIT_WIDTH(FW), .POS_WIDTH(PW),
                    .CU_X(3), .CU_Y(2), .TILES(TILES), .GA(GA), .GB(GB),
                    .L1_PRIM(L1_PRIM),
                    .INST_DEPTH(INST_DEPTH), .RECV_DEPTH(RECV_DEPTH),
